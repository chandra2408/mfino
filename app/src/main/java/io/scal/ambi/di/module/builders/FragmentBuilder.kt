...
import io.scal.ambi.ui.home.classes.discussion.DiscussionModule
...
abstract class FragmentBuilder {
    ...
    @ContributesAndroidInjector(modules = [DiscussionModule::class])
    abstract fun bindDiscussionFragment(): DiscussionFragment
