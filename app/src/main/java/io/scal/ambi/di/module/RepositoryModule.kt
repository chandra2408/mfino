...
import io.scal.ambi.model.repository.data.newsfeed.NotebooksRepository
...
abstract class RepositoryModule {
    ...
    @Singleton
    @Binds
    abstract fun bindNotebookListRepository(newsFeedRepository: NotebooksRepository): INotebooksRepository
}