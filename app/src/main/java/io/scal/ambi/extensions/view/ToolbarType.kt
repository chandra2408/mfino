...
data class ToolbarType constructor(val leftIcon: IconImage?,
                                   ...
                                   val textActionButton: String? = null,
                                   val textActionButtonClickListener: Runnable? = null,
    ...
    constructor(leftIcon: IconImage?, content: Content?, rightIcon: IconImage?,rightIcon2: IconImage?,textActionButton: String?)  :
            this(leftIcon, null, content, rightIcon, null, rightIcon2, null, textActionButton, null)
    ...
    constructor(@DrawableRes leftIcon: Int?, content: Content?, @DrawableRes rightIcon: Int?, @DrawableRes rightIcon2: Int?, textActionButton: String?) :
            this(leftIcon?.let { IconImage(it) }, content, rightIcon?.let { IconImage(it) }, rightIcon2?.let { IconImage(it) },textActionButton)
