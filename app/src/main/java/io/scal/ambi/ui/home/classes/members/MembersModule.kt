...
internal abstract class MembersModule {
    ...
    companion object {
        ...
        fun provideAboutData(activity: MembersFragment): ClassesData {
            return activity.arguments!!.getSerializable(MembersFragment.EXTRA_CLASS_ITEM) as? ClassesData ?: ClassesData("","", "", "", DateTime.now(), "", "", "", DateTime.now(), emptyList(), "", emptyList(), emptyList())
        }
