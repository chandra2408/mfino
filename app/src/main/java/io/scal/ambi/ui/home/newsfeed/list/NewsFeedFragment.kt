...
import io.scal.ambi.ui.home.root.HomeSearchViewModel
...
class NewsFeedFragment : BaseNavigationFragment<NewsFeedViewModel, FragmentNewsFeedBinding>() {
    ...
    private val homeSearchViewModel: HomeSearchViewModel by lazy {
        ViewModelProviders.of(this, viewModelFactory).get(HomeSearchViewModel::class.java)
    }
