...
class ChatListViewModel @Inject internal constructor(private val context: Context,
    ...
    val filterModel = ChatFilterModel(listOf(UIChatListFilter.AllChats, UIChatListFilter.ClassChats,UIChatListFilter.GroupChats, UIChatListFilter.OrganizationChats))
    ...
    fun initChatTypeFilters(filtersSelected: Int) {
        filterModel.onFilterClicked(filtersSelected)
        filterModel
            .selectedFilter
            .toObservable()
