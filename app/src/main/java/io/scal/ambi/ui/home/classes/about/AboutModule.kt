...
internal abstract class AboutModule {
    ...
    companion object {
        ...
        fun provideAboutData(activity: AboutFragment): ClassesData {
            return activity.arguments!!.getSerializable(AboutFragment.EXTRA_CLASS_ITEM) as? ClassesData ?: ClassesData("","","","",DateTime.now(),"","","",DateTime.now(), emptyList(),"", emptyList(), emptyList())
        }
