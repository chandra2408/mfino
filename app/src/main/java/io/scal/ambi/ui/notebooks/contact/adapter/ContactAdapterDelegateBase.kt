...
import io.scal.ambi.ui.notebooks.contact.SelectContactViewModel

internal abstract class ContactAdapterDelegateBase<in Binding : ViewDataBinding>(private val viewModel: ItemSelectContactViewModel) :
