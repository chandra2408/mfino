...
class PickerViewModel @Inject constructor(private val filePathHelper: FilePathHelper,
    ...
    fun pickAnImage(viewController: PickerViewController, context: Context, cameraOrGallery: Boolean ) {
        if(cameraOrGallery){
            if(context.packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA)){
                ...
                viewController.startActivityForResult(PhotoPickerDialogFragment.getCameraIntent(imageUri), REQUEST_CODE_OPEN_GALLERY)
            }else{
