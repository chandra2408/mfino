...
private fun String.createUser(gson: Gson): ItemUser {
    ...
    return when (generalUser.type) {
        ...
        ItemUser.Type.Admin -> gson.fromJson(this, UserResponse.BigUser::class.java)
        ItemUser.Type.Owner -> gson.fromJson(this, UserResponse.BigUser::class.java)
        ItemUser.Type.Staff -> gson.fromJson(this, UserResponse.BigUser::class.java)
    }
}