...
class TwilioChatRepository @Inject internal constructor(private val authenticationRepository: TwilioAuthenticationRepository,
    ...
    override fun sendChatMessage(chatUid: String, message: String, attachments: List<String>?, messageCode: String?): Single<ChatChannelMessage> =
        channelMessageHelper.sendChatMessage(chatUid, message,attachments,messageCode!!) // todo add attachment support
